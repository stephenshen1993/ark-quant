...
class TestTradingPageInteraction(unittest.TestCase):
    ...
    def test_account_plan_details_group_actions_once_above_execution_rows(self):
        ...
        self.assertIn(".plan-trade-code-col { width: 14%; }", self.html)
        self.assertIn(".plan-trade-name-col { width: 18%; }", self.html)
        self.assertIn(".plan-trade-quantity-col { width: 22%; }", self.html)
        self.assertIn(".plan-trade-price-col { width: 18%; }", self.html)
        self.assertIn(".plan-trade-amount-col { width: 28%; }", self.html)
        self.assertIn(".plan-trade-table th:nth-child(3),", self.html)
        self.assertIn(".plan-trade-table th:nth-child(n + 4),", self.html)
