...
class TestTradingPageInteraction(unittest.TestCase):
    ...
    def test_changelog_page_uses_static_aihot_style_stream(self):
        ...
        self.assertIn("--ark-bg: #f4f5f6", self.html)
        self.assertIn("--ark-text: #1b2733", self.html)
        self.assertIn("--ark-muted: #5c6672", self.html)
        self.assertIn("--ark-soft: #858c96", self.html)
        self.assertIn("--ark-line: #e3e4e7", self.html)
        self.assertIn("--ark-nav-active: #e9eef0", self.html)
        self.assertIn("--ark-accent: #125e6c", self.html)
        self.assertIn("--ark-update: #2e7e5d", self.html)
