...
class TestTradingPageInteraction(unittest.TestCase):
    ...
    def test_changelog_page_uses_static_aihot_style_stream(self):
        ...
        self.assertIn("--ark-nav-width: 179px", self.html)
        self.assertIn("--ark-reading-width: 833px", self.html)
        self.assertIn("--ark-reading-top: 80px", self.html)
        self.assertIn("--ark-header-stream-gap: 61px", self.html)
        self.assertIn("--ark-date-group-gap: 72px", self.html)
        self.assertIn("--ark-reading-time-column: 86px", self.html)
        self.assertIn("--ark-entry-column-gap: 22px", self.html)
        self.assertIn("--ark-entry-copy-indent: 24px", self.html)
        ...
        self.assertIn("width: var(--ark-nav-width)", self.html)
        self.assertIn("width: 100%", self.html)
        self.assertIn("workspace-shell", self.html)
        self.assertIn("max-width: var(--ark-reading-width)", self.html)
        self.assertIn("padding: var(--ark-reading-top) 0 96px", self.html)
        self.assertIn("grid-template-columns: var(--ark-reading-time-column) minmax(0, 1fr)", self.html)
        self.assertIn(".changelog-date-header", self.html)
        self.assertIn("--ark-bg: #f7f8fa", self.html)
        self.assertIn("--ark-text: #111827", self.html)
        self.assertIn("--ark-changelog-canvas: #f4f5f6", self.html)
        self.assertIn("--ark-changelog-ink: #1b2733", self.html)
        self.assertIn("--ark-changelog-secondary: #5c6672", self.html)
        self.assertIn("--ark-changelog-tertiary: #858c96", self.html)
        self.assertIn("--ark-changelog-line: #e3e4e7", self.html)
        self.assertIn("--ark-changelog-nav-active: #e9eef0", self.html)
        self.assertIn("--ark-changelog-accent: #125e6c", self.html)
        self.assertIn("--ark-changelog-update: #2e7e5d", self.html)
        self.assertIn("border-bottom: 1px solid var(--ark-changelog-line)", self.html)
        self.assertIn("font-size: 32px", self.html)
        self.assertIn("font-size: 24px", self.html)
        self.assertIn("font-size: 18px", self.html)
    ...
    def test_account_page_uses_aihot_workbench_container(self):
        ...
        self.assertIn("account-ledger-row", self.html)
        self.assertIn("account-position-row", self.html)
        self.assertIn(".account-ledger-row", self.html)
        self.assertIn("responsive-table-scroll", self.html)
        self.assertIn("账户事实日", self.html)
    ...
    def test_plan_page_uses_aihot_workbench_container(self):
        ...
        self.assertIn("plan-ranking-table", self.html)
        self.assertIn("plan-order-table-scroll", self.html)
        self.assertIn("WORKBENCH", self.html)
