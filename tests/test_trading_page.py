...
class TestTradingPageInteraction(unittest.TestCase):
    ...
    def test_changelog_page_uses_static_aihot_style_stream(self):
        ...
        self.assertLess(self.html.index(">计划<"), self.html.index(">更新日志<"))
        ...
        self.assertIn("width: 180px", self.html)
        self.assertIn("workspace-shell", self.html)
        self.assertIn("max-width: 840px", self.html)
        self.assertIn("grid-template-columns: 110px minmax(0, 1fr)", self.html)
        ...
        self.assertIn("font-size: 36px", self.html)
