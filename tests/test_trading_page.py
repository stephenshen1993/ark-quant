...
class TestTradingPageInteraction(unittest.TestCase):
    ...
    def test_changelog_page_uses_static_aihot_style_stream(self):
        ...
        self.assertIn("--ark-nav-width: 240px", self.html)
        self.assertIn("--ark-reading-width: 1128px", self.html)
        self.assertIn("--ark-reading-top: 108px", self.html)
        self.assertIn("--ark-reading-time-column: 150px", self.html)
