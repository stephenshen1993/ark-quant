...
- `docs/看板/Web看板.md`：本地 Web 看板说明，包含启动、页面分工、数据来源和录入方式。
- `docs/体系/账户与金额口径.md`：账户、总资产、持仓资产、可用现金和金额展示口径。
- `docs/操作/日常看板流程.md`：盘后/盘前使用看板完成账户录入、策略检查和计划确认的流程。
- `docs/操作/体系再平衡手册.md`：体系级再平衡运行手册，定义输入、公式、执行顺序和把关规则。
- `docs/体系/个人投资体系规则书.md`：当前正式投资体系规则，定义资产类别、策略、账户三类概念和目标仓位公式。
- `docs/体系/交易与调拨战术规则.md`：交易计划、资金调拨、输入窗口、下单现金来源和复盘清单。
